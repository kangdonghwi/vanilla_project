...
function start() {
  ...
  bird.setAttribute("class", "bird"); //div요소에 attribute를 새로 생성해서 넣어줌
  ...
  window.requestAnimationFrame(playGame); //애니메이션을 부드럽게 만들어주는 함수
}
...
function makePipe(pipePos) {
  ...
  pipeDown.style.backgroundColor = "blue";
